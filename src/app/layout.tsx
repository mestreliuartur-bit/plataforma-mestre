    ...
    <html lang="pt-BR" className={`${inter.variable} ${cinzel.variable} dark`}>
      <body className="bg-[#0a0a0f] font-sans text-white antialiased">
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-black/40 transition-all duration-300 hover:scale-110 hover:bg-[#20c05a] hover:shadow-xl hover:shadow-[#25D366]/20"
        >
