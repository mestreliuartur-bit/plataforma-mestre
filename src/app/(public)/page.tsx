...
const MOCK_EVENTS = [
  {
    ...
    isWhatsappLead: false, whatsappNumber: null, whatsappMessage: null,
  },
  {
  ...
  const [banners, dbEvents] = await Promise.all([
    ...
    db.event.findMany({
      ...
      select: {
        ...
        price: true, type: true, coverImage: true,
        isWhatsappLead: true, whatsappNumber: true, whatsappMessage: true,
      },
    }),
  ]);
