            ...
            {hasAccess && embedUrl ? (
              ...
              <div className="flex aspect-video w-full items-center justify-center bg-gray-950">
                <div className="text-center">
                  ...
                  <p className="mt-4 text-gray-500">Vídeo não configurado para esta aula</p>
                </div>
              </div>
            ) : (
              /* Sem acesso — tela de bloqueio */
              <div className="flex aspect-video w-full flex-col items-center justify-center gap-6 bg-gradient-to-br from-gray-950 to-[#0d0d1a]">
                <div className="flex h-20 w-20 items-center justify-center rounded-full border border-amber-400/20 bg-amber-400/5">
                ...
                <div className="text-center">
                  <h2 className="font-serif text-2xl font-bold text-white">Conteúdo Exclusivo</h2>
                  <p className="mt-2 text-gray-400">
                    Adquira o curso <strong className="text-white">{course.title}</strong> para acessar esta aula.
                  </p>
                </div>
                {course.isWhatsappLead ? (
                  <a
                    href={`https://wa.me/${course.whatsappNumber ?? "5511910998013"}?text=Quero adquirir o curso: ${encodeURIComponent(course.title)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 rounded-full bg-green-600 px-8 py-4 font-semibold text-white hover:bg-green-500"
                  >
